...
async function loadCart() {
  ...
  try {
    ...
    if (snap.exists()) {
      ...
      cart      = saved.map(i => ({ name: i.name, price: parseFloat(i.price), quantity: i.quantity }));
...
const STORE_LAT = 10.678675625390419;   // ← Cebu City, Philippines (example)
const STORE_LNG = 122.41150998625238;   // ← Cebu City, Philippines (example)
